 ...
 * Optimized to improve initial popup load time (DOMContentLoaded).
 */
...
document.getElementById('export-pdf').onclick = async () => {
  try {
    // Lazy load heavy html2pdf library (~885KB) only when needed
...
document.getElementById('to-notion').onclick = async () => {
  try {
    ...
    setStatus('✗ Failed to load Notion API');
    console.error(e);
  }
};
